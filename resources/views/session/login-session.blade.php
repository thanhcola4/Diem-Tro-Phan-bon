            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">            
                <div class="card-body">
                  <form role="form" method="POST" action="/session">
                    ...
                    <label>Email</label>
                    <div class="mb-3">
                      <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="huynhnguyen150400@gmail.com" aria-label="Email" aria-describedby="email-addon">
                      @error('email')
                    ...
                    <div class="form-check form-switch">
                      ...
                      <label class="form-check-label" for="rememberMe">Lưu</label>
                    </div>
